    ...
    <div className="inner-page">
      <section className="page-hero" style={{ background: "var(--ink)" }}>
        ...
        <div className="container page-hero-content">
          <motion.p className="eyebrow" style={{ color: "var(--sage)" }} initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2 }}>About TSP Tensile Structures</motion.p>
        ...
        <div className="container">
          <motion.div className="about-statement-inner" variants={staggerContainer} initial="hidden" animate={iv1 ? "visible" : "hidden"}>
            ...
            <motion.p variants={fadeUp}>
              TSP Tensile Structures is a tensile architecture practice based in Lahore, with offices in Islamabad and Rawalpindi. We design, engineer, fabricate and install custom tensile shade and membrane structures for residential, commercial, hospitality and institutional clients across Pakistan.
            </motion.p>
            <motion.p variants={fadeUp}>
      ...
      <section className="page-cta-band">
        <div className="container">
          <motion.div variants={staggerContainer} initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.4 }}>
            ...
            <motion.h2 variants={fadeUp}>The person behind TSP Tensile Structures.</motion.h2>
